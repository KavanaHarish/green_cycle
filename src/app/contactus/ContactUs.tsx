...
const ContactUs = () => {
  ...
  return (
    ...
    <Head>
     ...
     <meta name="description" content="Have questions about e-waste management or our platform? Get in touch with GreenCycle's dedicated team for personalized assistance and information." />
    </Head>
