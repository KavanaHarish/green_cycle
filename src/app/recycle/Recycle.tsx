  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Responsibly recycle your electronic devices with GreenCycle's specialized recycling programs for smartphones, laptops, TVs, refrigerators and more." />
      </Head>
